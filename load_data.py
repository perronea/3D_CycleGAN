...
def load_data(image_folder, input_modality, nr_of_channels, batch_size=1, 
    ...
    train_A_path = os.path.join(image_folder, input_modality)
    train_B_path = os.path.join(image_folder, input_modality)
    test_A_path = os.path.join(image_folder, input_modality)
    test_B_path = os.path.join(image_folder, input_modality)
    ...
    if generator:
        ...
        return {"train_A_images": train_A_images,  "train_A_image_names": train_A_image_names,
                ...
                "test_A_images": train_A_images,  "test_A_image_names": train_A_image_names,
